 ...
 * @author Gonza Cozzo
 */
public class Ejercicio03_barajaCartasMain {
    ...
    public static void main(String[] args) {
        ...
        //ServicioCarta serCard = new ServicioCarta();
        ServicioBaraja serBaraja = new ServicioBaraja();
        Baraja mazo = new Baraja();
       
        mazo = serBaraja.crearMazo();

        serBaraja.barajar(mazo);
        serBaraja.siguienteCarta(mazo);
        serBaraja.darCartas(mazo);
        serBaraja.cartasDisponibles(mazo);
        serBaraja.mostrarBaraja(mazo);
        serBaraja.cartasMonton();

 ...
 */
package Ejercicio03_extra_libreria;

import Ejercicio03_extra_libreria.servicios.ServicioLibro;

/**
 *
 * @author Gonza Cozzo
 */
public class Ejercicio03_extra_libreriaMain {
    ...
    public static void main(String[] args) {
        ...
        servLibro.agregarLibro();
        servLibro.mostrarLibros();
        servLibro.prestamo();
        servLibro.mostrarLibros();
        servLibro.devolucion();
        servLibro.mostrarLibros();*/
        
        servLibro.ejecutarMenu();

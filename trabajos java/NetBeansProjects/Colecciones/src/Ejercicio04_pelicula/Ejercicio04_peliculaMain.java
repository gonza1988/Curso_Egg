 ...
 */
package Ejercicio04_pelicula;

import Ejercicio04_pelicula.servicios.ServicioPelicula;

/**
 *
 * @author Gonza Cozzo
 */
public class Ejercicio04_peliculaMain {
    ...
    public static void main(String[] args) {
        ...
        En el main deberemos tener un bucle que crea un objeto Pelicula pidiéndole al usuario
        ...
        spelicula.CrearPelicula();
        spelicula.mostrarPelicula();
        spelicula.ordenarPelicula();
